 ...
 */
public class ClipZoomImageView3 extends ImageView implements
    ...
    public ClipZoomImageView3(Context context) {
        this(context, null);
    }

    public ClipZoomImageView3(Context context, AttributeSet attrs) {
        super(context, attrs);
                ...
                new SimpleOnGestureListener() {
                    ...
                    public boolean onDoubleTap(MotionEvent e) {
                        ...
                        if (getScale() < SCALE_MID) {
                            ClipZoomImageView3.this.postDelayed(
                                    new AutoScaleRunnable(SCALE_MID, x, y), 16);
                            Log.e("SunySan","此时的SCALE_MID == "+SCALE_MID);
                            isAutoScale = true;
                        } else {
                            ClipZoomImageView3.this.postDelayed(
                                    new AutoScaleRunnable(initScale, x, y), 16);
                            Log.e("SunySan","此时的initScale == "+initScale);
                            isAutoScale = true;
                        }
    ...
    private class AutoScaleRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((tmpScale > 1f) && (currentScale < mTargetScale))
                ...
                ClipZoomImageView3.this.postDelayed(this, 16);

                mScaleMatrix.postScale(tmpScale, tmpScale, x, y);
                Log.e("SunySan", "我在缩放呢：tmpScale == " + tmpScale + "  x == " + x + "  y == " + y);
                checkBorder();
            ...
            // 设置为目标的缩放比例
            {
                ...
                Log.e("SunySan", "我在缩放呢,deltaScale == " + deltaScale + "  x == " + x + "  y == " + y);
                checkBorder();
                setImageMatrix(mScaleMatrix);
                isAutoScale = false;
            }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isCanDrag) {
                    if (getDrawable() != null) {
                        ...
                        if (mode == MODE.ZOOM) {
                            rotation = rotations(event) - oldRotation;
                            mScaleMatrix.postRotate(rotation / 8, getWidth() / 2,
                                    getHeight() / 2);
