 ...
 */
public class ClipZoomImageView1 extends ImageView implements
	...
	public ClipZoomImageView1(Context context) {
		this(context, null);
	}

	public ClipZoomImageView1(Context context, AttributeSet attrs) {
		super(context, attrs);
				...
				new SimpleOnGestureListener() {
					...
					public boolean onDoubleTap(MotionEvent e) {
						...
						if (getScale() < SCALE_MID) {
							ClipZoomImageView1.this.postDelayed(
	...
	private class AutoScaleRunnable implements Runnable {
		...
		public void run() {
			...
			if (((tmpScale > 1f) && (currentScale < mTargetScale))
				...
				ClipZoomImageView1.this.postDelayed(this, 16);
			} else
			// 设置为目标的缩放比例
			{
